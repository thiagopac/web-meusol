...
function createPlan(){
  ...
  $request = \Slim\Slim::getInstance()->request();
	...
	$sqlPlanInsert = "INSERT INTO PLAN (NAME, DURATION, DISCOUNT_ID) VALUES (:planName, :planDuration, :discountId)";
  ...
  try{
      ...
      //SQL AND BIND
      $stmt = $conn->prepare($sqlPlanInsert);
      ...
      $feedbackMessage = "Plano adicionado com sucesso";
      ...
      if ($affectedData > 0) {
        ...
        $response->feedbackMessage = "Não foi possível criar o plano.";
      }
