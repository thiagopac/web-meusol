...
function createPlanDetail(){
  ...
  $request = \Slim\Slim::getInstance()->request();
	...
	$sqlPlanDetailInsert = "INSERT INTO PLAN_DETAIL (DESCRIPTION, PLAN_ID) VALUES (:planDetailDescription, :planId)";
  ...
  try{
      ...
      //SQL AND BIND
      $stmt = $conn->prepare($sqlPlanDetailInsert);
      ...
      $feedbackMessage = "Item do plano adicionado com sucesso";
      ...
      if ($affectedData > 0) {
        ...
        $response->feedbackMessage = "Não foi possível criar o item de plano.";
      }
